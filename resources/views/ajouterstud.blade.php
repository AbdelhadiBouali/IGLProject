    ...
    <div class="testbox">
      ...
      {{csrf_field() }}
        ...
        <div class="item">
          <p>Nom et prénom</p>
          <div class="name-item">
            <input type="text" name="stud_name" placeholder="Nom complet"/>
          </div>
        </div>
        <div class="item">
        ...
        <div class="question">
          <p>Règlement et conditions<span class="required">*</span></p>
          <div class="question-answer checkbox-item">
            <div>
              <input type="checkbox" value="none" id="check_1" name="check" required/>
              <label for="check_1" class="check"><span>J'accepte les<a href="https://www.w3docs.com/privacy-policy">conditions</a></span></label>
            </div>
          </div>
        </div>
        <div class="btn-block">
          <input type="submit" name="submit" class="btn btn-success" value="Sauvegarder">
        </div>
